...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '_build_wasm/lvgl_widgets_demo.data';
      var REMOTE_PACKAGE_BASE = 'lvgl_widgets_demo.data';
...
Module['FS_createPath']("/src", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile__build_wasm/lvgl_widgets_demo.data');

      };
      Module['addRunDependency']('datafile__build_wasm/lvgl_widgets_demo.data');
    ...
    loadPackage({"files": [{"filename": "/src/resources/foo", "start": 0, "end": 0}], "remote_package_size": 0});
...
var wasmBinaryFile;
  wasmBinaryFile = 'lvgl_widgets_demo.wasm';
...
var ASM_CONSTS = {
  243104: () => { window.onkeydown = function(e) { return !(e.keyCode == 32); }; }
};
...
var ___start_em_js = Module['___start_em_js'] = 243171;
var ___stop_em_js = Module['___stop_em_js'] = 243244;
